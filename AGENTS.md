...
Текущая версия: v54 (сентябрь 2026). Тестов: 94 (`logic` + `ios` + `sync` + `sync-devices` + `journal`).
...
- Настройки (repo/token) живут в ⚙; там же диагностика, ручной синк, установка PWA, 3 очистки.
